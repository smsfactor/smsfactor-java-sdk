...
public abstract class Campaign extends SMS
{
	...
	public static CampaignSendResponse send(Map<String, Object> params, boolean simulate) throws SMSFactorException
	{
		...
		CampaignSendResponse response = staticRequest(RequestMethod.POST, url, CampaignSendResponse.class, smsFactorParams);
	...
	public static CampaignSendResponse sendToLists(Map<String, Object> params, boolean simulate) throws SMSFactorException
	{
	...
	public static CampaignHistoryResponse history(Map<String, Object> params) throws SMSFactorException
	{
		...
		CampaignHistoryResponse response = staticRequest(RequestMethod.GET, url, CampaignHistoryResponse.class, smsFactorParams);
